...
MainWindow::MainWindow(const QString &artistTable, const QString &albumTable, QFile *albumDetails, QWidget *parent) : QMainWindow(parent)
{
    file = albumDetails;
    readAlbumData();
    ...
    connect(model, &QSqlRelationalTableModel::rowsInserted, this, &MainWindow::updateHeader);
    connect(model, &QSqlRelationalTableModel::rowsRemoved, this, &MainWindow::updateHeader);
...
{
    QMessageBox::about(this, tr("Hakkında"), tr("<p><b>Bilgi Yarışması</b> uygulaması.</p><p>github.com/atakli/</p>"));
}
